const STEPS = [
  ...
  {
    title: "Try Demo Mode",
    sub: "Great for first time visitors.",
    html: `<p><strong>Step 4 — Try Demo Mode :</strong> Swipe or scroll <em>the header to reveal the Try Demo Mode button </em>, click it to enter the practice arena. Hone your skills in a risk-free environment before jumping into the real game. Don't skip this step—it's the best way to get ready!</p>
           <div class="hint">Tip: This step is essential for first-time visitors to familiarize themselves with the platform.</div>`
  },
  {
    title: "Play",
